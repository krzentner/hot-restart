        ...
        while not PROGRAM_SHOULD_EXIT and not EXIT_THIS_FRAME:
            ...
            try:
                ...
                if not PROGRAM_SHOULD_EXIT and not EXIT_THIS_FRAME:
                    ...
                    new_tb, num_dead_frames = _create_undead_traceback(excinfo[2], sys._getframe(1))
...
def _create_undead_traceback(exc_tb, current_frame):
    ...
    num_dead_frames = -1
    dead_frame = exc_tb.tb_frame
    while dead_frame is not None:
        num_dead_frames += 1
        dead_frame = dead_frame.f_back
    ...
    return prev_tb, max(0, num_dead_frames)
